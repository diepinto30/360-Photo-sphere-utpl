...
public class CameraMovement : MonoBehaviour {
    ...
    void Update()
    {
        ...
        {  // If left mouse button down:
            float rotateAboutY = Input.GetAxis("Mouse X") * Time.deltaTime * rotateSpeed;    // Mouse movement up/down.
            float rotateAboutX = -Input.GetAxis("Mouse Y") * Time.deltaTime * rotateSpeed;  // Mouse movement right/left.
